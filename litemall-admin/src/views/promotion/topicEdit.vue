<template>
  <div class="app-container">
    ...
    <el-form ref="topic" :rules="rules" :model="topic" status-icon label-position="left" label-width="100px" style="width: 800px; margin-left:50px;">
      <el-form-item label="在线课程标题" prop="title">
        <el-input v-model="topic.title" />
      </el-form-item>
      <el-form-item label="在线课程子标题" prop="subtitle">
        <el-input v-model="topic.subtitle" />
      </el-form-item>
      <el-form-item label="在线课程图片" prop="picUrl">
        <el-upload
          :headers="headers"
          :action="uploadPath"
      ...
      <el-form-item label="课程商品" prop="goods">
        ...
        <el-table :data="goodsList" border fit highlight-current-row>
          ...
          <el-table-column align="center" label="课程介绍" prop="brief" />
    ...
    <el-dialog :visible.sync="addVisiable" title="添加商品">
      <div class="search">
        <el-input v-model="listQuery.goodsSn" clearable class="filter-item" style="width: 200px;" placeholder="请输入课程编号" />
