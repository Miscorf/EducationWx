    ...
    >
      <el-tabs tab-position="left">
        <el-tab-pane label="首页配置">
          <el-form-item label="新品首发栏目课程显示数量" prop="litemall_wx_index_new">
            <el-input v-model="dataForm.litemall_wx_index_new" />
          </el-form-item>
          <el-form-item label="人气推荐栏目课程显示数量" prop="litemall_wx_index_hot">
            <el-input v-model="dataForm.litemall_wx_index_hot" />
          </el-form-item>
          <el-form-item label="品牌机构直供栏目显示数量" prop="litemall_wx_index_brand">
          ...
          <el-form-item label="分类栏目课程显示数量" prop="litemall_wx_catlog_goods">
            <el-input v-model="dataForm.litemall_wx_catlog_goods" />
          </el-form-item>
        </el-tab-pane>
        <el-tab-pane label="其他配置">
          <el-form-item label="课程分享功能" prop="litemall_wx_share">
